...
//	}
	...
	//	porsia maestrico = new porsia(codigo, txtDescripcion.getValue()); 
	...
	private void cargarTabla(){
		List<porsia> arr_maestricos = new ArrayList<porsia>();
		//arr_maestricos = mdao.listarMaestricos(tabla);
		listaMaestricos.setModel(new ListModelList<porsia>(arr_maestricos));
	}
