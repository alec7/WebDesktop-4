        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="index.html"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Reportes</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                          <li class="active"><a href="index.html">Clientes</a></li> 
                           <li class="active"><a href="index.html">Agenda</a></li> 
                            <li class="active"><a href="index.html">Servicio</a></li>
                             <li class="active"><a href="index.html">Estadisticas de sugerencias de clientes</a></li> 
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="graph_flot.html">Empresa</a></li>
                            <li><a href="graph_flot.html">Convenios</a></li>
