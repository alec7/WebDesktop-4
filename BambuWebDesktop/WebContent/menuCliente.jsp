        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="index.html"><i class="fa fa-tags"></i> <span class="nav-label">Servicio</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="index.html"><i class="fa fa-pencil-square-o"></i>Solicitud de servicio</a></li>
                        </ul>
                    </li>
                    
                    <li>
                        <a href="#"><i class="fa fa-address-book-o"></i> <span class="nav-label">Agenda</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="graph_flot.html">Mis citas</a></li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-search"></i> <span class="nav-label">Seguimiento</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="graph_flot.html">Mis Avances</a></li>
                            <li><a href="graph_flot.html">Detalle de Servicio</a></li>
